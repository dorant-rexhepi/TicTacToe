...
class GameViewModel: ViewModel() {
    ...
    private fun addValueToBoard(cellNo: Int) {
        ...
        if (state.currentTurn == BoardCellValue.CIRCLE) {
            ...
            if (chackForVictory(BoardCellValue.CIRCLE)) {
                state = state.copy(
            ...
            if (chackForVictory(BoardCellValue.CROSS)) {
                state = state.copy(
    ...
    private fun chackForVictory(boardValue: BoardCellValue): Boolean {
        when {
